...
if (process.env.XUMM_API_KEY && process.env.XUMM_API_SECRET) {
  try {
    ...
    console.log('✅ [XUMM] XUMM SDK initialized successfully');
  } catch (error) {
    console.warn('⚠️  [XUMM] Failed to initialize XUMM SDK:', error.message);
    Sdk = null;
  }
} else {
  console.warn('⚠️  [XUMM] XUMM API credentials not found, SDK not initialized');
}
