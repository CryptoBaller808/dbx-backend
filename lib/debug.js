 ...
 * Production-safe: Always returns false in production
 * @returns {boolean} False in production, true only in development with explicit flag
 */
function isDebug() {
  ...
  return coerceBool(process.env.DEBUG_MODE);
}
